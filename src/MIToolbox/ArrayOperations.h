...
/*******************************************************************************
** Returns the first element of each sample of a vectorized matrix of this type:
    **     f  e  a  t  u  r  e  s
    ** s [f1] e1 a1 t1 u1 r1 e1 s1
    ** a [f2] e2 a3 t3 u3 r3 e3 s3
    ** m
    ** p
    ** l
    ** e
...
*******************************************************************************/
void firstElementOfEachSample(double **feature2D,double *vector,int noOfFeatures,int noOfSamples);

/*******************************************************************************
** Increments each value in a double array
*******************************************************************************/
void incrementVector(int* vector, int vectorLength);
